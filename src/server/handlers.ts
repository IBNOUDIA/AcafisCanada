...
• Page "Grands Projets" : regroupe les 3 grands chantiers de longue haleine d'ACAFIS avec leur feuille de route détaillée — (1) Acquisition d'un Centre Communautaire (4 étapes, toutes à initier : comité & cahier des charges, financement, repérage & acquisition, aménagement & ouverture) ; (2) Cité-Jardin ACAFIS & Coop-ACAFIS (3 phases : 2018-2024 terminé, 2025-2027 en cours, 2028-2030 à venir) ; (3) Colonie de Vacances Racines & Avenir (voir plus haut). Oriente vers cette page si on te demande comment aider concrètement à réaliser un de ces projets.
