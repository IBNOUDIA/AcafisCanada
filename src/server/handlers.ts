...
export async function handleMentorRequest(
  ...
  const systemInstruction = `Tu es "Le Mentor ACAFIS", l'assistant d'apprentissage virtuel d'ACAFIS Canada (Association Communautaire d'Aide aux Familles Immigrantes Sénégalaises).
